  ...
  def ping
    if user_signed_in? then
      if current_user.profile then
        ...
        PingMailer.ping_email(@profile.user.email, current_user.profile.name, params[:msg], current_user.email, profile_url(@profile, host: "http://protected-harbor-8849.herokuapp.com")).deliver
